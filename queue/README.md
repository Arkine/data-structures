...
## Applications
- Queues are used whenver we need to manage objects in order starting with first one
- Allows for an ordered call of items within the queue

- Can be implemeted using an array or a linked-list
